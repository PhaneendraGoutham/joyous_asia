						...
						<div class="form-horizontal">
							...
							<div style="padding-bottom: 55px;">
								...
								<div class="form-group" style="background: lightsalmon; width: 13%; float: right;">
									<label class="col-sm-6 col-md-6 col-lg-6 control-label" style=" font-weight: bold;  margin-top: -2px; text-align: right; font-size: 15px; color:#ffffff;">Delay:</label>
							...
							<sf:hidden path="rentalCollectDate"/>
